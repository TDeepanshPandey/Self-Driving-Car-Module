...
class Car(Widget):
    ...
    def move(self, rotation):
        ...
        if self.sensor1_x>longueur-20 or self.sensor1_x<20 or self.sensor1_y>largeur-10 or self.sensor1_y<20:
            self.signal1 = 1.
        if self.sensor2_x>longueur-20 or self.sensor2_x<20 or self.sensor2_y>largeur-10 or self.sensor2_y<20:
            self.signal2 = 1.
        if self.sensor3_x>longueur-20 or self.sensor3_x<20 or self.sensor3_y>largeur-10 or self.sensor3_y<20:
            self.signal3 = 1.
